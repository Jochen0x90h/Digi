...
#
# create application which depends on given libraries and may have resources
# FILES: the source files of the application
# LIBRARIES: libraries to include
# RESOURCES: additional resource files to include
# ARCHITECTURE: architecture suffix for executable. Recommended values are:
#   Windows 32bit: x86
#   Windows 64bit: AMD64
#   OSX: not needed because OS X supports universal binaries
#
function(CREATE_APP TARGET)
	...
	foreach(_arg ${_val_args} ${_bool_args})
		set(${_arg} "") # only works with empty string
	endforeach()
	...
	if(ARCHITECTURE)
		set(TARGET ${TARGET}.${ARCHITECTURE})
	endif()
	...
	if(WIN32)
		set(RESOURCES_DIR "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_CFG_INTDIR}/Resources")
